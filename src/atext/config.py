...
class Settings(BaseSettings):
    ...
    stripe_secret_key: str | None = Field(
        default=None,
        validation_alias=AliasChoices("STRIPE_SECRET_KEY", "ATEXT_STRIPE_SECRET_KEY", "stripe_secret_key"),
    )
    stripe_webhook_secret: str | None = Field(
        default=None,
        validation_alias=AliasChoices("STRIPE_WEBHOOK_SECRET", "ATEXT_STRIPE_WEBHOOK_SECRET", "stripe_webhook_secret"),
    )
    stripe_price_id: str | None = Field(
        default=None,
        validation_alias=AliasChoices("ATEXT_STRIPE_PRICE_ID", "STRIPE_PRICE_ID", "stripe_price_id"),
    )
