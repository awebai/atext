...
- [Measure conditions, not counts](extract-conditions-not-counts.md) — grep tallies are blind to behaviour; extract the guard+config, dedupe your own tool calls out, and verify the instrument can see the phenomenon before trusting a null.
